  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, paddingBottom: 8, overflow: "hidden" }}>
        ...
        <div style={{ padding: "10px 10px 4px", opacity: prog(frame, 40, 24) }}>
          <div style={{
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "8px 10px 6px" }}>
        {NAV.system.map((it) => <NavItem key={it.label} {...it} appear={prog(frame, 44, 24)} />)}
      </div>

      {/* User-Card */}
      <div style={{ padding: "6px 10px 18px", opacity: prog(frame, 48, 24) }}>
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            {purchasedCredits > 0 ? (
              ...
              <div style={{ width: 70, height: 2, borderRadius: 2, background: "rgba(255,255,255,0.08)", overflow: "hidden" }}>
                <div style={{ height: "100%", width: `${pct * prog(frame, 30, 50)}%`, borderRadius: 2, background: ACCENT }} />
              </div>
            )}
          </div>
        </div>
...
export const DashboardHero = ({
  ...
  const headerAppear = prog(frame, 18, 34);
  const donutFill = prog(frame, 62, 80);
      ...
      <div style={{ width: DESIGN_W, height: DESIGN_H, position: "relative", transform: `scale(${scale})`, transformOrigin: "center", overflow: "hidden", flexShrink: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 12 }}>
            <StatCard frame={frame} start={26} label="Bezahlt diesen Monat" value={paidThisMonth}
            ...
            <StatCard frame={frame} start={32} label="Versendet & offen" value={sentCount}
            ...
            <StatCard frame={frame} start={38} label="Aktive Kunden" value={customerCount}
            ...
            <StatCard frame={frame} start={44} label="Überfällige Posten" value={overdueCount}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 12, marginBottom: 12 }}>
            <GlassCard accent={`${ACCENT}55`} appear={prog(frame, 52, 34)} style={{ padding: "22px 24px 18px" }}>
              ...
              <AreaChart values={monthlySent} months={months} frame={frame} start={64} />
            </GlassCard>

            <GlassCard appear={prog(frame, 58, 34)} style={{ padding: "22px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <GlassCard appear={prog(frame, 68, 34)} style={{ padding: "22px 22px" }}>
            ...
            <GlassCard appear={prog(frame, 74, 34)} style={{ padding: "22px 22px" }}>
